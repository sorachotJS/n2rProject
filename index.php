          ...
          <div class="theme-form login-form needs-validation" novalidate="">
            ...
            <div class="form-group">
              ...
              <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                <input class="form-control" type="text" required="" placeholder="xxxx" id="username">
            ...
            <div class="form-group">
              ...
              <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                <input class="form-control" type="password" name="login[password]" required="" placeholder="*********" id="password">
            ...
            <div class="form-group">
              <button class="btn btn-primary btn-block" type="submit" onclick="signInClick()">Sign in</button>
            </div>
  ...
  <script>
    (function() {
      ...
      if (sessionStorage.getItem("UserName")) {
        window.location.href = "main-dashboard.php?page=default";
      }
        ...
        success: function(data) {
          ...
          if (data.loginStatus === "1") {
            ...
            Swal.fire({
              ...
              html: 'We will go to dashboard in <b></b> milliseconds.',
              timer: 2000,
